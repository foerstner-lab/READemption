...
class ReadAligner(object):
    ...
    def build_index(self, ref_seq_file_paths, index_file_path):
        self.segemehl.build_index(ref_seq_file_paths, index_file_path)
        
    def run_alignment(self, read_file_paths, ref_seq_file_paths, 
        ...
        for read_file_path, output_file_path, nomatch_file_path in zip(
            ...
            self.segemehl.align_reads(
                read_file_path, index_file_path, ref_seq_file_paths, 
