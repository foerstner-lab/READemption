...
class TestPaths(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.static_files = [
            ...
            self.paths.annotation_file_stats,
    ...
    def test_required_folders(self):
        self.assertEqual(len(self.paths.required_folders()), 15)

    def test_get_read_files(self):
        self.paths.read_fasta_folder = self.test_folder
        self._create_folder_with_files(self.test_folder, self.test_files)
        self.assertEqual(self.paths.get_read_files(), sorted(self.test_files))
        self._remove_folder_if_exists(self.test_folder)
