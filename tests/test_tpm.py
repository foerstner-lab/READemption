...
def test_tpm_calculation():
	raw = pd.DataFrame(data={"Orientation of counted reads relative to the strand location of the annotation":
								 ["sense", "sense", "sense"],
						...
						"Strand": ["+", "+", "+"],
						"Frame": ["0", "0", "0"],
						"Attributes": ["ID=cds0;Name=YP_005179941.1",
									   "ID=cds1;Name=YP_005179942.1",
									   "ID=cds2;Name=YP_005179943.1"],
						"InSPI2_R1":["6", "10", "80"],
						"InSPI2_R2":["10", "20", "20"]})
	expected_tpm = pd.DataFrame(data={"Orientation of counted reads relative to the strand location of the annotation":
								 ["sense", "sense", "sense"],
						"Sequence name": ["NC_016810.1", "NC_016810.1", "NC_016810.1"],
						"Source": ["RefSeq", "RefSeq", "RefSeq"],
						"Feature": ["CDS", "CDS", "CDS"],
	...
	calculated_tpm = GeneWiseOverview._calculate_tpm("self", raw, ["InSPI2_R1", "InSPI2_R2"])
