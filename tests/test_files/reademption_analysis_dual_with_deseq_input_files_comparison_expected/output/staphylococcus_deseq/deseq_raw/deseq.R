...
library('gplots')
library('ggplot2')
rawCountTable <- read.table('a_test_project/output/staphylococcus_gene_quanti_combined/gene_wise_quantifications_combined.csv', skip=1, sep='\t', quote='', comment.char='', colClasses=c(rep('character',10), rep('numeric',15)))
...
countTable <- countTable[, c('Co_culture_replicate_1','Co_culture_replicate_2','Co_culture_replicate_3','Harboring_replicate_1','Harboring_replicate_2','Harboring_replicate_3','Infected_replicate_1','Infected_replicate_2','Infected_replicate_3','Steady_state_replicate_1','Steady_state_replicate_2','Steady_state_replicate_3')]
libs <- c('Co_culture_replicate_1','Co_culture_replicate_2','Co_culture_replicate_3','Harboring_replicate_1','Harboring_replicate_2','Harboring_replicate_3','Infected_replicate_1','Infected_replicate_2','Infected_replicate_3','Steady_state_replicate_1','Steady_state_replicate_2','Steady_state_replicate_3')
conds <- c('co_culture', 'co_culture', 'co_culture', 'harboring', 'harboring', 'harboring', 'infected', 'infected', 'infected', 'steady_state', 'steady_state', 'steady_state')
...
# PCA plot
pdf('a_test_project/output/staphylococcus_deseq/deseq_raw/sample_comparison_pca_heatmap.pdf')
rld <- rlog(dds)
...
write.table(comp0, file='a_test_project/output/staphylococcus_deseq/deseq_raw/deseq_comp_co_culture_vs_harboring.csv', quote=FALSE, sep='\t')
...
write.table(comp1, file='a_test_project/output/staphylococcus_deseq/deseq_raw/deseq_comp_co_culture_vs_infected.csv', quote=FALSE, sep='\t')
#Comparison: co_culture vs. steady_state 
countTable2 <- countTable[, c('Co_culture_replicate_1','Co_culture_replicate_2','Co_culture_replicate_3','Steady_state_replicate_1','Steady_state_replicate_2','Steady_state_replicate_3')]
libs2 <- c('Co_culture_replicate_1','Co_culture_replicate_2','Co_culture_replicate_3','Steady_state_replicate_1','Steady_state_replicate_2','Steady_state_replicate_3')
conds2 <- c('co_culture','co_culture','co_culture','steady_state','steady_state','steady_state')
...
comp2 <- results(dds2, contrast=c('condition','co_culture', 'steady_state'))
write.table(comp2, file='a_test_project/output/staphylococcus_deseq/deseq_raw/deseq_comp_co_culture_vs_steady_state.csv', quote=FALSE, sep='\t')
...
write.table(comp3, file='a_test_project/output/staphylococcus_deseq/deseq_raw/deseq_comp_harboring_vs_co_culture.csv', quote=FALSE, sep='\t')
...
write.table(comp4, file='a_test_project/output/staphylococcus_deseq/deseq_raw/deseq_comp_harboring_vs_infected.csv', quote=FALSE, sep='\t')
#Comparison: harboring vs. steady_state 
countTable5 <- countTable[, c('Harboring_replicate_1','Harboring_replicate_2','Harboring_replicate_3','Steady_state_replicate_1','Steady_state_replicate_2','Steady_state_replicate_3')]
libs5 <- c('Harboring_replicate_1','Harboring_replicate_2','Harboring_replicate_3','Steady_state_replicate_1','Steady_state_replicate_2','Steady_state_replicate_3')
conds5 <- c('harboring','harboring','harboring','steady_state','steady_state','steady_state')
...
comp5 <- results(dds5, contrast=c('condition','harboring', 'steady_state'))
write.table(comp5, file='a_test_project/output/staphylococcus_deseq/deseq_raw/deseq_comp_harboring_vs_steady_state.csv', quote=FALSE, sep='\t')
...
write.table(comp6, file='a_test_project/output/staphylococcus_deseq/deseq_raw/deseq_comp_infected_vs_co_culture.csv', quote=FALSE, sep='\t')
...
write.table(comp7, file='a_test_project/output/staphylococcus_deseq/deseq_raw/deseq_comp_infected_vs_harboring.csv', quote=FALSE, sep='\t')
#Comparison: infected vs. steady_state 
countTable8 <- countTable[, c('Infected_replicate_1','Infected_replicate_2','Infected_replicate_3','Steady_state_replicate_1','Steady_state_replicate_2','Steady_state_replicate_3')]
libs8 <- c('Infected_replicate_1','Infected_replicate_2','Infected_replicate_3','Steady_state_replicate_1','Steady_state_replicate_2','Steady_state_replicate_3')
conds8 <- c('infected','infected','infected','steady_state','steady_state','steady_state')
...
comp8 <- results(dds8, contrast=c('condition','infected', 'steady_state'))
write.table(comp8, file='a_test_project/output/staphylococcus_deseq/deseq_raw/deseq_comp_infected_vs_steady_state.csv', quote=FALSE, sep='\t')
#Comparison: steady_state vs. co_culture 
countTable9 <- countTable[, c('Steady_state_replicate_1','Steady_state_replicate_2','Steady_state_replicate_3','Co_culture_replicate_1','Co_culture_replicate_2','Co_culture_replicate_3')]
libs9 <- c('Steady_state_replicate_1','Steady_state_replicate_2','Steady_state_replicate_3','Co_culture_replicate_1','Co_culture_replicate_2','Co_culture_replicate_3')
conds9 <- c('steady_state','steady_state','steady_state','co_culture','co_culture','co_culture')
...
comp9 <- results(dds9, contrast=c('condition','steady_state', 'co_culture'))
write.table(comp9, file='a_test_project/output/staphylococcus_deseq/deseq_raw/deseq_comp_steady_state_vs_co_culture.csv', quote=FALSE, sep='\t')
#Comparison: steady_state vs. harboring 
countTable10 <- countTable[, c('Steady_state_replicate_1','Steady_state_replicate_2','Steady_state_replicate_3','Harboring_replicate_1','Harboring_replicate_2','Harboring_replicate_3')]
libs10 <- c('Steady_state_replicate_1','Steady_state_replicate_2','Steady_state_replicate_3','Harboring_replicate_1','Harboring_replicate_2','Harboring_replicate_3')
conds10 <- c('steady_state','steady_state','steady_state','harboring','harboring','harboring')
...
comp10 <- results(dds10, contrast=c('condition','steady_state', 'harboring'))
write.table(comp10, file='a_test_project/output/staphylococcus_deseq/deseq_raw/deseq_comp_steady_state_vs_harboring.csv', quote=FALSE, sep='\t')
#Comparison: steady_state vs. infected 
countTable11 <- countTable[, c('Steady_state_replicate_1','Steady_state_replicate_2','Steady_state_replicate_3','Infected_replicate_1','Infected_replicate_2','Infected_replicate_3')]
libs11 <- c('Steady_state_replicate_1','Steady_state_replicate_2','Steady_state_replicate_3','Infected_replicate_1','Infected_replicate_2','Infected_replicate_3')
conds11 <- c('steady_state','steady_state','steady_state','infected','infected','infected')
...
comp11 <- results(dds11, contrast=c('condition','steady_state', 'infected'))
write.table(comp11, file='a_test_project/output/staphylococcus_deseq/deseq_raw/deseq_comp_steady_state_vs_infected.csv', quote=FALSE, sep='\t')
