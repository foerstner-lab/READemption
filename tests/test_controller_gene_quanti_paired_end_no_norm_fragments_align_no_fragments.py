...
class TestController(unittest.TestCase):
    def setUp(self):
        ...
        self.maxDiff = None
        self.dual_fresh = "tests/test_files/reademption_analysis_dual_paired_end_with_gene_quanti_paired_end_no_fragments_input_files"
        ...
        self.dual_expected = "tests/test_files/reademption_analysis_dual_with_gene_quanti_paired_fragments_but_no_norm_fragments_expected"
...
class TestControllerGeneQuantiPairedEnd(TestController):
    def test_gene_quanti_paired_end_fragments_align_fragments(self):
        self._version = 2.0
