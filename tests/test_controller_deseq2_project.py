...
class TestController(unittest.TestCase):
    def setUp(self):
        ...
        self.maxDiff = None
        self.dual_fresh = "tests/test_files/reademption_analysis_dual_with_deseq_input_files_project_fresh"
        ...
        self.dual_expected = "tests/test_files/reademption_analysis_dual_with_deseq_input_files_project_expected"
